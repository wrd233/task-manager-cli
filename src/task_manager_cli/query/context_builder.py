...
class ContextBuilder:
    ...
    def build_object_context(self, object_id: int, redact: bool = True, record_limit: int = 80) -> Dict[str, Any]:
        ...
        return {
            ...
            "annotations": self.repo.list_annotations(target_object_id=object_id, limit=50),
    ...
    def build_agent_context(self, object_type: str = None, limit: int = 20, redact: bool = True) -> Dict[str, Any]:
        objects = self.repo.list_objects(object_type=object_type, limit=limit)
        packages: List[Dict[str, Any]] = []
        for obj in objects:
            packages.append(self.build_object_context(int(obj["id"]), redact=redact, record_limit=20))
        return {
